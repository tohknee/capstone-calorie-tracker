...
def get_one_profile(id):
    """
    Gets one pet profile of any user
    """
...
def post_one_calorie_goal(id):
    ...
    return jsonify({'error': 'Pet you are trying to make a caloric goal for does not belong to you.'}), 401
...
def post_one_weight_goal(id):
    ...
    return jsonify({'error': 'Pet you are trying to make a weight goal for does not belong to you.'}), 401
